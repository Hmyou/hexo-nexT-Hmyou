...
$(document).ready(function() {
  ...
  $('img').each(function () {
    if(this.alt){
      $(this).after('<p style="text-align:center;position:relative;top:-20px;color:#999;"><span style="border-bottom: 1px solid #d9d9d9;padding-bottom: 5px;">    [ '+this.alt+' ]    </span></p>');
    }
  });
